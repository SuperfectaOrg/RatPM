...
mod mock {
    ...
    extern "C" {
        ...
        pub fn dnf5_transaction_add_install(
            trans: *mut dnf5_transaction,
            pkg: *mut dnf5_package,
        ) -> c_int;
        pub fn dnf5_transaction_add_remove(
            trans: *mut dnf5_transaction,
            pkg: *mut dnf5_package,
        ) -> c_int;
        pub fn dnf5_transaction_add_upgrade(
            trans: *mut dnf5_transaction,
            pkg: *mut dnf5_package,
        ) -> c_int;
